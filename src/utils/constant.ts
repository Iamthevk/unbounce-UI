...
export const BENEFITS_DATA = [
    ...
    {
        heading: "Benefit 1",
        paragraph: "Highlight the benefits of signing up for an appointment,online class, or video consultation.",
        src: "https://d9hhrg4mnvzow.cloudfront.net/templates.unbounce.com/multor/13b0f11a-multor-benefit1-icon.svg"
    },
    {
        heading: "Benefit 2",
        paragraph: "For example, fitness instructors might describe how their routines make people healthier *and* happier.",
        src: "https://d9hhrg4mnvzow.cloudfront.net/templates.unbounce.com/multor/8ab92ea8-multor-benefit2-icon.svg"
    },
    {
        heading: "Benefit 3",
        paragraph:"Remind visitors how easy it is to claim your offer and start enjoying the benefits.",
